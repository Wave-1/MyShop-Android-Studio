...
public class Constants {
    public static final String INTENT_KEY_ORDER_STATUS = "INITIAL_ORDER_STATUS";
    public static final String ORDER_STATUS_ALL = "Tất cả";
    public static final String ORDER_STATUS_PROCESSING = "Đang xử lý";
    public static final String ORDER_STATUS_SHIPPING = "Chờ giao hàng";
